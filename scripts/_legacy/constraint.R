...
VARFILE        <- "gnomad_variants_all.csv"
...
# ----------------------------
if (isTRUE(WRITE_INTERMEDIATES)) {
  write_csv(d0, file.path(OUTDIR, "loeuf_lt_0.2_all_genes_with_ci_metrics.csv"))
  write_csv(d1, file.path(OUTDIR, "loeuf_lt_0.2_precision_filtered.csv"))
  write_csv(discordant, file.path(OUTDIR, "discordant_genes_top_oe_lof.csv"))
  ...
  write_csv(qc, file.path(OUTDIR, "qc_summary.csv"))
